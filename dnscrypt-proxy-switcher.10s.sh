...
if [ "$current_resolvers_name" = "${DNSCRYPT_NAME}" ]; then
	echo "$PROXY_ICON"
elif [ "$current_resolvers_name" = "${DNSCRYPT_NAME} + ${ADDITIONAL_NAME}" ]; then
...
echo "Safe Resolvers"
if [ "$current_resolvers_name" = "${DNSCRYPT_NAME}" ]; then
	echo "✓ ${DNSCRYPT_NAME} | color=green terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS}' trim=false"
	echo "    ${DNSCRYPT_NAME} + ${ADDITIONAL_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS} ${ADDITIONAL_IPS}' trim=false"
	echo "    ${ADDITIONAL_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${ADDITIONAL_IPS}' trim=false"
	echo "---"
	echo "Unsafe Resolvers"
	echo "    DHCP default DNS | terminal=false refresh=true bash=\"${0}\" param1=empty trim=false"
elif [ "$current_resolvers_name" = "${DNSCRYPT_NAME} + ${ADDITIONAL_NAME}" ]; then
	echo "    ${DNSCRYPT_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS}' trim=false"
	echo "✓ ${DNSCRYPT_NAME} + ${ADDITIONAL_NAME} | color=green terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS} ${ADDITIONAL_IPS}' trim=false"
	echo "    ${ADDITIONAL_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${ADDITIONAL_IPS}' trim=false"
	echo "---"
	echo "Unsafe Resolvers"
	echo "    DHCP default DNS | terminal=false refresh=true bash=\"${0}\" param1=empty trim=false"
	...
	echo "    ${DNSCRYPT_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS}' trim=false"
	echo "    ${DNSCRYPT_NAME} + ${ADDITIONAL_NAME} | terminal=false refresh=true bash=\"${0}\" param1='${DNSCRYPT_PROXY_IPS} ${ADDITIONAL_IPS}' trim=false"
	echo "✓ ${ADDITIONAL_NAME} | color=green terminal=false refresh=true bash=\"${0}\" param1='${ADDITIONAL_IPS}' trim=false"
	echo "---"
	echo "Unsafe Resolvers"
	echo "    DHCP default DNS | terminal=false refresh=true bash=\"${0}\" param1=empty trim=false"
else
	...
	echo "---"
	echo "Unsafe Resolvers"
	echo "✓ DHCP default DNS | color=red terminal=false refresh=true bash=\"${0}\" param1=empty trim=false"
fi
echo "---"
